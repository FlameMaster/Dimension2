package com.melvinhou.model3d_sample.wiget;
...
import com.melvinhou.model3d_sample.sample.D3SampleRenderer;
 ...
 * ================================================
 */
public class D3ShowSurfaceView extends GLSurfaceView {
    ...
    private D3SampleRenderer mRenderer;

    public D3SampleRenderer getD3Renderer() {
        return mRenderer;
    }

    public void setD3Renderer(D3SampleRenderer renderer) {
        this.mRenderer = renderer;
        super.setRenderer(renderer);
    }


    public D3ShowSurfaceView(Context context) {
        this(context, null);
    }

    public D3ShowSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
