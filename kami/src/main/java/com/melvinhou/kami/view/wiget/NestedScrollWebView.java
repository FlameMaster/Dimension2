...
//        img.getLocationInWindow(location); //获取在当前窗口内的绝对坐标
//                getLocationOnScreen(location);//获取在整个屏幕内的绝对坐标
//                Log.w("web滑动","\ty= "+ev.getRawY()+"\ty= "+location[1]+"\tscrolly= "+getScrollY());
                break;
...
//                Log.d("web滑动", new StringBuffer("方法:onTouchEvent\n")
