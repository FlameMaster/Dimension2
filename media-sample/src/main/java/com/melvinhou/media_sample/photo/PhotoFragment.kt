 ...
 * ================================================
 */
class PhotoFragment : BindFragment<FragmentPhotoBinding, BaseViewModel>() {
    ...
    private val TAG = PhotoFragment::class.java.name
    ...
    override fun initListener() {
        mAdapter = MyAdapter()
        mLayoutManager = ViewPagerLayoutManager(requireContext(),ViewPagerLayoutManager.HORIZONTAL)
    ...
    override fun initData() {
        val list = requireActivity().intent.getStringExtra("url")?.split(",")
        mAdapter?.clearData()
        list?.let {
