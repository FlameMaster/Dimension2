 ...
 * = 地 点：中 国 北 京 市 朝 阳 区
 * <p>
 * = 时 间：2022/4/26 0026 13:44
 * <p>
 * = 分 类 说 明：分割符和默认占位符的输入框
 * ================================================
 */
    ...
    public DivisionEditText(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs,
                    R.styleable.DivisionEdit);
            this.totalLength = typedArray.getInteger(
                    R.styleable.DivisionEdit_totalLength, 0);
            this.eachLength = typedArray.getInteger(
                    R.styleable.DivisionEdit_eachLength, 0);
            this.delimiter = typedArray
                    .getString(R.styleable.DivisionEdit_delimiter);
            if (this.delimiter == null || this.delimiter.length() == 0) {
                this.delimiter = "-";
            }
            this.placeHolder = typedArray
                    .getString(R.styleable.DivisionEdit_placeHolder);
