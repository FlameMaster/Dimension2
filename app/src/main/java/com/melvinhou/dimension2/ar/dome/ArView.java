...
public class ArView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            MatrixState.translate(0, 0, -2f);   //ch.obj
            //绕Y轴、Z轴旋转
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            lovo = LoadUtil.loadFromFile("ar/models/girl.obj", getContext().getResources(), ArView.this);
            Log.e("fancl", "Finish loading");
            //加载纹理
            textureId = initTexture(R.mipmap.girl_body);
        }
    }
}