 ...
 * ================================================
 */
public class Test4View extends ViewGroup implements NestedScrollingParent3 {
    ...
    public Test4View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Test4View(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onStopNestedScroll(@NonNull View target, int type) {
        ...
        if (mSideContainerTop > mSideContainerInitialTop) {
            if (mSwipeListener != null
                    ...
                    && Math.abs(mSideContainerTop - mSideContainerInitialTop) > mTopSwipeHeight / 2) {
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (targetY > mSideContainerInitialTop) {
            if (type == ViewCompat.TYPE_TOUCH) {
                //阻力值
                float proportion = 1f - (float) (targetY - mSideContainerInitialTop) / (float) mTopSwipeHeight;
                unitY = (int) ((float) dyUnconsumed * proportion * proportion);
            } else {
                unitY = 0;
            }
        }
