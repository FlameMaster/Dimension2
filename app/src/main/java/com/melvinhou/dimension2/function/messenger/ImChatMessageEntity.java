 ...
 * ================================================
 */
@Entity(tableName = ImChatMessageEntity.TABLE_NAME)
public class ImChatMessageEntity {
    ...
    public ImChatMessageEntity(){

    }

    @Ignore
    public ImChatMessageEntity(long uuid, String message, String date, long userId){
        setUserId(uuid);
        setUserId(userId);
        setMessage(message);
        setDate(date);
