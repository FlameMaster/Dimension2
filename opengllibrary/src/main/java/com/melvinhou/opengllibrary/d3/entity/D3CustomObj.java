 ...
 * = 地 点：中 国 北 京 市 朝 阳 区
 * <p>
 * = 时 间：2023/5/25 0025 16:45
 * <p>
 * = 分 类 说 明：默认的一个实现
 * ================================================
 */
public class D3CustomObj implements D3Object {
    private static final String TAG = D3CustomObj.class.getSimpleName();
    //着色器文件
    private static final String VERTEX_SHADER_NAME = "d3/shaders/dome.vert";
    private static final String FRAGMENT_SHADER_NAME = "d3/shaders/dome.frag";


    //顶点数
    private int vertexCount;
    //顶点坐标缓冲，顶点法向量缓冲，顶点纹理坐标缓冲,光源位置缓冲,相机位置缓冲
    private FloatBuffer vertexBuffer, normalBuffer, texCoordBuffer, lightPositionBuffer, cameraBuffer;
    // 纹理id
