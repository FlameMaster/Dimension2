...
class TiktokService {
    ...
    companion object {
        val instance = TiktokService()
    }

    private var mService: TiktokApi? = null

    fun Api(): TiktokApi {
        if (mService == null)
            mService = create(TiktokApi::class.java)
     ...
     * 动态代理模式
     */
    fun create(service: Class<TiktokApi>): TiktokApi {
        val proxy = Proxy.newProxyInstance(
            ...
            object : InvocationHandler {
                ...
                override fun invoke(proxy: Any, method: Method, args: Array<Any>?): Any? {
                    ...
                    //method=TiktokApi.getMediaList()/path=sample_media_list.json
