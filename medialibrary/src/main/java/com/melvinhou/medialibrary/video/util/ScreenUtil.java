package com.melvinhou.medialibrary.video.util;
...
public class ScreenUtil {
    ...
    public static int getPxByDp(float dp) {
        float scale = FcUtils.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int dip2px(float dpValue) {
        final float scale = FcUtils.getContext().getResources().getDisplayMetrics().density;
