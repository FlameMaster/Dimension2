 ...
 * ================================================
 */
abstract class KindActivity<VB : ViewBinding, M : BaseViewModel> : BindActivity<VB, M>() {
    override fun openViewBinding(): VB = _ViewBinding
    override fun openModelClazz(): Class<M> = _ModelClazz
    protected abstract val _ViewBinding: VB
