...
//        super.initWindowUI();
    ...
    protected void initData() {
        loadNetImage(R.id.player_photo, NetGameConstant.SERVER_RES +"image/game/poker/player.jpg");
        loadNetImage(R.id.player1, NetGameConstant.SERVER_RES +"image/game/poker/player1.png");
        loadNetImage(R.id.player2, NetGameConstant.SERVER_RES +"image/game/poker/player2.png");
        reStart(null);
    }
