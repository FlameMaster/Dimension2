...
/**
 * 这个类从摄像机feed中呈现AR背景。它创建并托管给ARCore的纹理，以填充相机图像.
 */
public class BackgroundRenderer {
  private static final String TAG = BackgroundRenderer.class.getSimpleName();

  // 材质名称.
  private static final String CAMERA_VERTEX_SHADER_NAME = "ar/shaders/screenquad.vert";
  private static final String CAMERA_FRAGMENT_SHADER_NAME = "ar/shaders/screenquad.frag";
  private static final String DEPTH_VISUALIZER_VERTEX_SHADER_NAME =
          "ar/shaders/background_show_depth_color_visualization.vert";
  private static final String DEPTH_VISUALIZER_FRAGMENT_SHADER_NAME =
          "ar/shaders/background_show_depth_color_visualization.frag";
  ...
  /**
   * 分配和初始化后台渲染器所需的OpenGL资源。必须在OpenGL线程上被调用, typically in {@link GLSurfaceView.Renderer#onSurfaceCreated(GL10,
   * EGLConfig)}.
   *
