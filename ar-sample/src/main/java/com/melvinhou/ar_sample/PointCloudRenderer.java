...
public class PointCloudRenderer {
  ...
  // 渲染点云.
  private static final String VERTEX_SHADER_NAME = "ar/shaders/point_cloud.vert";
  private static final String FRAGMENT_SHADER_NAME = "ar/shaders/point_cloud.frag";
