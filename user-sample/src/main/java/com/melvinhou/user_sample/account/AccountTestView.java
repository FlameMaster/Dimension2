 ...
 * ============================================================
 */
public class AccountTestView extends ConstraintLayout implements NestedScrollingChild2 {
    ...
    public AccountTestView(Context context) {
        this(context, null);
    }

    public AccountTestView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AccountTestView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    fling(-initialVelocity);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dispatchNestedScroll(0, deltaY - dyUnconsumed, 0, dyUnconsumed, mScrollOffset, ViewCompat.TYPE_TOUCH)) {
                }
            default:
...
//                    .toString());
            if (dy != 0) {//还有剩余滚动量
                ...
                //web滚动
                super.computeScroll();
                if (!dispatchNestedScroll(0, consumedY, 0, unconsumedY, null, ViewCompat.TYPE_NON_TOUCH)) {
